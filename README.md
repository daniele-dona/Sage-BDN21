...
The file "Cases" lists the 63 cases of thin groups collected in Tables 2 and 3, and the corresponding verification matrices of Sections 5 and 6. The reader can just append the relevant case at the end of the program file and compile to proceed with the verification. All outputs are "True".
